...
import ir.part.sdk.ara.util.androidsvg.CSSParser.Ruleset;
...
public class SVG
{
   ...
   {
      PathDefinition                pathDef = SVGParser.parsePath(pathDefinition);
   ...
   public Set<String> getViewList()
   {
      ...
      List<SvgObject> viewElems = getElementsByTagName();
   ...
   {
      this.cssRules.removeFromSource();
   }
   ...
   */
   ...
   private List<SvgObject> getElementsByTagName()
   {
      List<SvgObject>  result = new ArrayList<>();

      // Search the object tree for nodes with the give element class
      getElementsByTagName(result, rootElement, View.NODE_NAME);
      return result;
   }
