...
import ir.part.sdk.ara.util.androidsvg.CSSParser.CSSTextScanner;
import ir.part.sdk.ara.util.androidsvg.CSSParser.MediaType;
import ir.part.sdk.ara.util.androidsvg.SVG.Box;
import ir.part.sdk.ara.util.androidsvg.SVG.CSSClipRect;
...
import ir.part.sdk.ara.util.androidsvg.SVG.Style.TextDirection;
...
import ir.part.sdk.ara.util.androidsvg.SVG.TextChild;
import ir.part.sdk.ara.util.androidsvg.SVG.TextPositionedContainer;
import ir.part.sdk.ara.util.androidsvg.SVG.TextRoot;
        ...
        while (true) {
            ...
            switch (pathCommand) {
                ...
                case 'm':
                    ...
                    if (Float.isNaN(y)) {
                        Timber.e("Bad path coords for " + ((char) pathCommand) + " path segment");
                        return path;
                    }
        ...
        try {
            if (enableInternalEntities) {
                ...
                if (preamble.indexOf("<!ENTITY ") >= 0) {
                    ...
                    Timber.d("Switching to SAX parser to process entities");
                    parseUsingSAX(is);
                    return svgDocument;
                }
            }
            ...
            Timber.e(e, "Error occurred while performing check for entities.  File may not be parsed correctly if it contains entity definitions.");
            parseUsingXmlPullParser(is);
            return svgDocument;
        } finally {
            try {
                ...
                Timber.e("Exception thrown closing input stream");
            }
        }
    }
